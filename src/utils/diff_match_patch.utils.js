...
var e = a.length > b.length ? a : b,
    ...
    g = e.indexOf(f);
return -1 != g
    ? ((c = [new diff_match_patch.Diff(DIFF_INSERT, e.substring(0, g)), new diff_match_patch.Diff(DIFF_EQUAL, f), new diff_match_patch.Diff(DIFF_INSERT, e.substring(g + f.length))]),
    ...
    ? ((b = e[1]), (f = e[3]), (a = e[4]), (e = this.diff_main(e[0], e[2], c, d)), (c = this.diff_main(b, f, c, d)), e.concat([new diff_match_patch.Diff(DIFF_EQUAL, a)], c))
    ...
    a[f][0] == DIFF_EQUAL
        ...
        : (a[f][0] == DIFF_INSERT ? (l += a[f][1].length) : (k += a[f][1].length),
          e &&
              ...
              (a.splice(c[d - 1], 0, new diff_match_patch.Diff(DIFF_DELETE, e)), (a[c[d - 1] + 1][0] = DIFF_INSERT), d--, d--, (f = 0 < d ? c[d - 1] : -1), (k = l = h = g = 0), (e = null), (b = !0))),
        f++;
...
for (f = 1; f < a.length; ) {
    if (a[f - 1][0] == DIFF_DELETE && a[f][0] == DIFF_INSERT) {
        ...
        if (d >= e) {
            ...
            a.splice(f, 0, new diff_match_patch.Diff(DIFF_EQUAL, b.substring(0, e))), (a[f - 1][0] = DIFF_INSERT), (a[f - 1][1] = c.substring(0, c.length - e)), (a[f + 1][0] = DIFF_DELETE), (a[f + 1][1] = b.substring(e)), f++;
        f++;
    }
    f++;
}
...
for (var b = !1, c = [], d = 0, e = null, f = 0, g = !1, h = !1, l = !1, k = !1; f < a.length; )
    a[f][0] == DIFF_EQUAL
        ? (a[f][1].length < this.Diff_EditCost && (l || k) ? ((c[d++] = f), (g = l), (h = k), (e = a[f][1])) : ((d = 0), (e = null)), (l = k = !1))
        : (a[f][0] == DIFF_DELETE ? (k = !0) : (l = !0),
          e &&
              ((g && h && l && k) || (e.length < this.Diff_EditCost / 2 && 3 == g + h + l + k)) &&
              (a.splice(c[d - 1], 0, new diff_match_patch.Diff(DIFF_DELETE, e)), (a[c[d - 1] + 1][0] = DIFF_INSERT), d--, (e = null), g && h ? ((l = k = !0), (d = 0)) : (d--, (f = 0 < d ? c[d - 1] : -1), (l = k = !1)), (b = !0))),
        f++;
b && this.diff_cleanupMerge(a);
};
        ...
        case DIFF_EQUAL:
            1 < c + d
                ? (0 !== c &&
                      ...
                      0 !== g &&
                          (0 < b - c - d && a[b - c - d - 1][0] == DIFF_EQUAL ? (a[b - c - d - 1][1] += f.substring(0, g)) : (a.splice(0, 0, new diff_match_patch.Diff(DIFF_EQUAL, f.substring(0, g))), b++),
                          (f = f.substring(g)),
                          (e = e.substring(g))),
        ...
        for (var e = d.start1, f = d.start2, g = ""; 0 !== d.diffs.length; ) {
            ...
            for (; 0 !== d.diffs.length && h.length1 < b - this.Patch_Margin; ) {
                ...
                g === DIFF_INSERT
                    ...
                    ? ((h.length1 += k.length), (e += k.length), (l = !1), h.diffs.push(new diff_match_patch.Diff(g, k)), d.diffs.shift())
            ...
            "" !== k &&
                ((h.length1 += k.length), (h.length2 += k.length), 0 !== h.diffs.length && h.diffs[h.diffs.length - 1][0] === DIFF_EQUAL ? (h.diffs[h.diffs.length - 1][1] += k) : h.diffs.push(new diff_match_patch.Diff(DIFF_EQUAL, k)));
            l || a.splice(++c, 0, h);
        }
    }
};
